...
/* the main function */
export default function ShowPostedJobsPage() {
  ...
  /* the array of dynamic changing statcards */
  const statCards = [
  ...
  return (
    <PageLayout>
      <div className="pb-20 animate-fade-in">
        ...
        {/* 
SECTION 1: hero section matching refined styles... */}
...
empty state logic and display */
          ...
          <>
          {/* 
the JOb card with the status toggle,metadata and
edit,clode and delete buttons*/}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filtered.map(job => {
