...
export default function ApplicantsPage() {
  ...
  return (
    <div className="min-h-screen bg-app-bg font-sans flex-col flex animate-fade-in">
      <Navbar />
      <main className="max-w-5xl mx-auto px-7 pb-20 pt-6 flex-1 w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            {filtered.length > 0 && (
              <button onClick={handleExportCSV}
                className="flex items-center gap-1.5 text-[12px] font-bold text-black bg-white border border-neutral-200 px-3 py-2.5 rounded-xl hover:neutral-50 transition-all">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4">
            {filtered.map(app => {
              ...
              return (
                <div key={app._id}
                  className="cs-card-modern hover:scale-[1.005] transition-all group">
