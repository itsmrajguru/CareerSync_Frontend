      ...
      <div className="pb-10 animate-fade-in">
        ...
        <section aria-label="Page header" className="mb-8 p-0 pt-4">
          <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-[60px]">
            ...
            <div style={{ flex: 1 }}>
              ...
              <div className="mb-7">
                ...
                <h1 className="cs-page-title">
                  Update your<br />
                  <span className="text-[#ef4444]">job posting.</span>
                </h1>
            ...
            {/* Right Column: High-Fidelity Image section */}
        ...
        {/* Banner with success and error display */}
        {success && (
        ...
        {loading ? (
          /* skeleton state while job data loads logic */
          ...
          <form onSubmit={handleSubmit} className="d-content flex flex-col gap-4">
            ...
            <div className="cs-card-modern flex items-center justify-between p-6">
              <div>
                <p className="cs-section-label">Posting Status</p>
            ...
            {/*Job Details Section logic and display */}
              ...
              <div className="flex flex-col gap-5">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input required type="text" name="title" value={formData.title} onChange={handleChange}
                    className="w-full p-3.5 rounded-xl bg-neutral-50 border border-neutral-200 text-black font-bold text-sm focus:outline-none focus:ring-4 focus:ring-primary-50 focus:border-primary-300 transition-all"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea required rows={7} name="description" value={formData.description} onChange={handleChange}
                    className="w-full p-3.5 rounded-xl bg-neutral-50 border border-neutral-200 text-black font-bold text-sm focus:outline-none focus:ring-4 focus:ring-primary-50 focus:border-primary-300 transition-all resize-none"
            ...
            {/* Details Section display and input */}
            <div className="bg-white border border-neutral-200 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <select name="jobType" value={formData.jobType} onChange={handleChange}
                    className="w-full p-3.5 rounded-xl bg-neutral-50 border border-neutral-200 text-black font-bold text-sm focus:outline-none focus:ring-4 focus:ring-primary-50 focus:border-primary-300 transition-all cursor-pointer">
                ...
                <div className="flex flex-col gap-1.5 sm:col-span-2">
                  ...
                  <input type="date" name="deadline" value={formData.deadline} onChange={handleChange}
                    ...
                    className="w-full sm:w-64 p-3.5 rounded-xl bg-neutral-50 border border-neutral-200 text-black font-bold text-sm focus:outline-none focus:ring-4 focus:ring-primary-50 focus:border-primary-300 transition-all cursor-pointer" />
                </div>
              </div>
            </div>
